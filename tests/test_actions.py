...
class ActionCatalogTests(unittest.TestCase):
    def test_first_mvp_has_small_explicit_allowlist(self) -> None:
        self.assertEqual(len(ACTION_SPECS), 59)
        ...
        self.assertTrue(require_action("apply_song_structure_regions").mutates_project)
        ...
        self.assertTrue(require_action("apply_reatune_preset").mutates_project)
        ...
        self.assertTrue(require_action("reorder_audio_tracks_by_source").mutates_project)
